...
export default function ImportPeserta() {
    ...
    return (
        <div className="min-h-screen bg-gray-100">
            <Navbar />
            {/* Main Content */}
            <main className="max-w-3xl mx-auto pt-24 pb-10">
                <div className="bg-white  rounded-xl shadow-md">
                    ...
                    <div className="mx-6 m-3 p-4 bg-blue-200 rounded-lg">
                        ...
                        <p className="mb-4">
                            ...
                            empat kolom, yaitu NAMA PESERTA,
                        ...
                        <ul className="list-disc list-inside mb-4">
                            ...
                            <li>
                                <strong>EMAIL</strong>, diisi email peserta. kode akses peserta akan dikirimkan ke
                                email tersebut (tentu saja email harus berbeda
                                antara peserta yang satu dengan yang lain).
                            </li>
                        </ul>
                        <p>
                    ...
                    <div >
                        <div className="mb-6 px-6">
                            ...
                            >
                                <FaDownload className="mr-2" /> Template Excel
                                Peserta
                            </a>
                        </div>
